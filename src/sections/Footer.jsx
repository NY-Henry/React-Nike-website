    ...
    <footer className="max-container">
      ...
      >
        <div className="flex flex-col items-start">
          <a href="/">
            <img src={footerLogo} width={150} height={56} />
          </a>
          <p
            className="mt-6 text-base leading-7  font-montserrat
          text-white-400 sm:max-w-sm "
          >
            Gte shoes ready from the new term at your nearest nike store. Find
      ...
      >
        ...
        items-center gap2 font-montserrat cursor-pointer"
        >
          <img
            src={copyrightSign}
            alt="copy right"
